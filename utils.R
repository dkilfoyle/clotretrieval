...
hiddenNumericInput = function (inputId, value, min = NA, max = NA, step = NA, width = NULL) 
{
  ...
  div(class = "form-group shiny-input-container", style = "display:none;", inputTag)
}
...
datetimeInput = function(inputId, label, datevalue = NULL, datemin = NULL, datemax = NULL,
  ...
  tagList(tags$div(id = inputId, class = "form-group shiny-input-container",
